...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
  ...
  hi MatchParen       ctermbg=242  ctermfg=229  guibg=#1c1c1c guifg=#ffffaf cterm=NONE           gui=NONE
  ...
  hi CursorLineNr     ctermbg=NONE ctermfg=73   guibg=#303030 guifg=#5fafaf cterm=NONE           gui=NONE
