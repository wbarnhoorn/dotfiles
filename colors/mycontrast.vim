...
hi LineNr guifg=#ffffff guibg=#2e2e2e guisp=#2e2e2e gui=bold ctermfg=DarkGrey ctermbg=NONE cterm=bold
...
hi Cursor guifg=#000000 guibg=#ffffff guisp=#ffffff gui=NONE ctermfg=15 ctermbg=15 cterm=NONE
...
hi MatchParen guifg=#cc8710 guibg=NONE guisp=NONE gui=NONE ctermfg=NONE ctermbg=166 cterm=NONE
